...
CREATE SEQUENCE moons_designation_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE moons_designation_seq OWNED BY moons.designation;
...
--
-- Name: designation; Type: DEFAULT; Schema: public; Owner: ec2-user
--

ALTER TABLE ONLY moons ALTER COLUMN designation SET DEFAULT nextval('moons_designation_seq'::regclass);
...
SELECT pg_catalog.setval('moons_designation_seq', 1, false);
...
INSERT INTO stars VALUES (1, 'Alpha Centauri B', 4, 'K', 3);
INSERT INTO stars VALUES (2, 'Alpha Orionis', 643, 'M', 9);
...
SELECT pg_catalog.setval('stars_id_seq', 2, true);
